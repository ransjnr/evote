...
import { ArrowRight, BarChart3, ShieldCheck, Users, Vote } from "lucide-react";
import {
  Accordion,
  AccordionItem,
  AccordionTrigger,
      ...
      <section className="py-24 bg-gray-50">
        <div className="container-custom mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Seamlessly manage ticket sales, reservations, and check-ins for
              your events
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mt-12">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Allow attendees to reserve tickets online for your events
                      with flexible pricing options and ticket types (VIP,
                      Regular, Early Bird).
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                    <svg
                      ...
                      strokeLinejoin="round"
                    >
                      <path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9M18 7l-6-2"></path>
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold mb-2">
                    ...
                    <p className="text-gray-600">
                      Automatically generate secure QR codes for verified
                      tickets that can be downloaded, printed, or shared
                      digitally.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0">
                    <svg
                      ...
                      strokeLinejoin="round"
                    >
                      <path d="M2 12h4M6 12h4M10 12h4M14 12h4M18 12h4"></path>
                      <path d="M22 17V7a2 2 0 00-2-2H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2z"></path>
                      <rect width="4" height="5" x="3" y="8" rx="1"></rect>
                      <rect width="4" height="5" x="17" y="8" rx="1"></rect>
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold mb-2">
                    ...
                    <p className="text-gray-600">
                      Streamline your event entry with our mobile scanner app
                      for quick QR code verification and real-time check-in
                      tracking.
                    </p>
                  </div>
                </div>
            ...
            <div className="order-1 md:order-2 bg-white p-8 rounded-2xl shadow-lg overflow-hidden relative">
              {/* Decorative elements */}
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-100 rounded-bl-3xl z-0"></div>
              <div className="absolute bottom-0 left-0 w-16 h-16 bg-green-100 rounded-tr-3xl z-0"></div>

              <div className="relative z-10">
                {/* Ticket mockup */}
                <div className="bg-white border-2 border-gray-200 rounded-xl overflow-hidden shadow-md mb-8 relative">
                  <div className="h-2 bg-primary"></div>
                  <div className="p-5">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <div className="text-sm text-gray-500">E-TICKET</div>
                    ...
                    <div className="flex justify-center my-4">
                      <div className="border-4 border-primary p-2 rounded">
                ...
                <div className="bg-gray-900 rounded-xl overflow-hidden shadow-lg">
                  ...
                  <div className="bg-gray-800 py-3 px-4 text-gray-400 text-xs flex justify-between">
                    <div>35 Checked In</div>
                    <div>152 Total Tickets</div>
                  </div>
                </div>
              </div>
            </div>
