        ...
        >
          ...
          <div className="flex justify-center gap-3">
            {isAcceptingNominations() && (
              <Button onClick={openSubmitDialog} size="lg">
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-500">
                  Categories for this nomination campaign haven't been set up
                  yet.
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-700 mb-1">{campaign.event.name}</p>
                ...
                <div>
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    {campaign.maxNominationsPerUser && (
                      <li>
                        • Maximum {campaign.maxNominationsPerUser} nominations
                        per person
                      </li>
                    )}
                    <li>
      ...
      <Dialog open={isSubmitDialogOpen} onOpenChange={setIsSubmitDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Fill out the form below to submit your nomination for{" "}
              {campaign.name}.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSubmitNomination} disabled={isSubmitting}>
              {isSubmitting ? (
                <>
